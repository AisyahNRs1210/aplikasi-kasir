                ...
                <select class="form-control" name="kode_satuan">
                    ...
                    <?php
                        ...
                        if(isset($detailProduk[0]->kode_satuan)) :
                            $detailProduk[0]->kode_satuan == $baris->kode_satuan ? $pilih = 'selected' : $pilih=null;
                        else :
                            $pilih=null;
                        endif;

                        echo '<option '.$pilih.'value="'.$baris->kode_satuan.'">'.$baris->nama_satuan.'</option>';
                        endforeach;
                        endif;
                    ?>
                </select>
            ...
            <div class="col-sm-9">
                <select class="form-control" name="kode_kategori">
                    ...
                    <?php
                        ...
                        if(isset($detailProduk[0]->kode_kategori)) :
                            $detailProduk[0]->kode_kategori == $baris->kode_kategori ? $pilih = 'selected' : $pilih=null;
                        else :
                            $pilih=null;
                        endif;

                        echo '<option '.$pilih.'value="'.$baris->kode_kategori.'">'.$baris->nama_kategori.'</option>';
                        endforeach;
                        endif;
                    ?>
                </select>
