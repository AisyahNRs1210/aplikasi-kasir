        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="menu-title">Transaksi</li>
                    <!-- <li>
                        <a href="widgets.html"> <i class="menu-icon ti-shopping-cart-full"></i>Pembelian Barang</a>
                    </li> -->
                   <li>
                        <a href="<?=site_url('form-penjualan');?>"> <i class="menu-icon ti-shopping-cart-full"></i>Penjualan Barang</a>
                    </li>
                   <!-- <li>
                        <a href="widgets.html"> <i class="menu-icon ti-printer"></i>Laporan Transaksi</a>
                    </li> -->
            </li>

             <li class="menu-title">Laporan</li>
                   <li>
                        <a href="<?=site_url('stok-barang');?>"><i class="menu-icon ti-printer"></i>Stok Barang</a>
                    </li>

                   <!-- <li>
                        <a href="<?=site_url('input-laporanpenjualan');?>"> <i class="menu-icon ti-money"></i>Penjualan</a>
                    </li> -->
            </li>
          </ul>
        </div>
        ...
        <div class="top-left">
          <div class="navbar-header">
            <a class="navbar-brand" href="./"
              ><img src="<?=base_url('admin/images/logo_ukk.png'); ?>" alt="Logo" style="width:70px;height:40px;"/></a>
          ...
          <div class="header-menu">
            ...
            <div class="user-area dropdown float-right">
              ...
              <div class="user-menu dropdown-menu">
                <a class="nav-link text-center" style="color:black;" href="#"><i class="fa fa- user"></i><?=session()->get('nama_user');?></a>
                <a class="nav-link text-center" style="color:black;" href="#"><i class="fa fa- user"></i><?=session()->get('role');?></a>
                <a class="nav-link" href="/edit-password"><i class="fa fa -cog"></i>Edit Password</a>
                 <a class="nav-link" href="/form-login"><i class="fa fa-power -off"></i>Logout</a>
              </div>
            </div>
          </div>
        </div>
                      ...
                      <div class="text-left dib">
                        <div class="stat-text">
                         <!-- Tampilkan jumlah total produk -->
                            <span class="count"><?= $totalProduk ?></span>
                            <!-- Tampilkan simbol & -->
                            <span>&</span>
                            <!-- Tampilkan jumlah total kategori -->
                            <span class="count"><?= $totalKategori ?></span>
                        </div>
                        <div class="stat-heading">Produk & kategori</div>
                      </div>
                    </div>
                  </div>
                </div>
...
<div class="row">
    ...
    <div class="col-xl-8">
        <div class="card">
            <div class="card-body">
                <h4 class="box-title">Data Kategori dan Satuan</h4>
            </div>
            <div class="card-body--">
                <div class="row">
                    <div class="col-md-6">
...
<!-- /.row -->
      ...
      <footer class="site-footer">
        <div class="footer-inner bg-white">
          <div class="row">
            <div class="col-sm-6">Copyright &copy; 2024 Yuzushi Gift Store</div>
            <div class="col-sm-6 text-right">
             Logged in as <?=session()->get('nama_user');?>
            </div>
          </div>
        </div>
      </footer>
    ...
    <script src= "<?=base_url('admin/js/simple-datatables.min.js'); ?>" ></script>
    <script src= "<?=base_url('admin/js/datatables-simple-demo.js'); ?>" ></script>
    <script src="<?=base_url('admin/assets/jQuery-Mask/dist/jquery.mask.js'); ?>"></script>
    ...
    <script src="<?=base_url('admin/assets/js/init/weather-init.js'); ?>"></script>

    <script src="https://cdn.jsdelivr.net/npm/moment@2.22.2/moment.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.js"></script>
    <script src="<?=base_url('admin/assets/js/init/fullcalendar-init.js'); ?>"></script>
