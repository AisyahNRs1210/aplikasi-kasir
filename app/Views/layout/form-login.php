        ...
        <div class="container">
            <div class="login-content">
                ...
                <div class="login-form">
                    <form action="<?=base_url('/form-login'); ?>" method="POST" novalidate>
                        ...
                        <div class="checkbox">
                            <!-- <label class="pull-left">
                                <a href="/edit-password">Lupa password?</a>
                            </label> -->
                        ...
                        <div class="register-link m-t-15 text-center">
                            <p>Belum punya akun? <a href="/form-registrasi"> Registrasi di sini</a></p>
                        </div>
                    </form>
                </div>
            </div>
